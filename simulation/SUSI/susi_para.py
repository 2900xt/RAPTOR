...
def get_susi_para(wlocation=None, peat=None, photosite='All data', folderName=None, hdomSim=None, volSim=None, 
    ...
    spara ={ 
        ...
        'ditch depth 20y west': [-0.3,-0.5,-0.7,-0.9,-1.1],                                            #ojan syvyys 20 vuotta simuloinnin aloituksesta
        'ditch depth 20y east': [-0.3,-0.5,-0.7,-0.9,-1.1],                                            #ojan syvyys 20 vuotta simuloinnin aloituksesta
        'scenario name': ['30cm', '50cm', '70cm', '90cm', '110cm'], #kasvunlisaykset
        ...
        'scenario name': ['Mese'], #kasvunlisaykset
        'initial h': -0.2, 'slope': 0.0, 
        'peat type':['A','A','A','A','A','A','A','A'],
        'peat type bottom':['A'],'anisotropy':10.,
        'vonP': False,
