...
#----Own functionalities from here
    ...
    def retranslateUi(self, MainWindowSusi):
        ...
        MainWindowSusi.setWindowTitle(_translate("MainWindowSusi", "Susi - Peatland Simulator 2020"))
        self.label.setText(_translate("MainWindowSusi", "Susi version 2.0 June 2020"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MainWindowSusi", "Start"))
        item = self.tableWidgetPeat.horizontalHeaderItem(0)
        item.setText(_translate("MainWindowSusi", "Depth [m]"))
        item = self.tableWidgetPeat.horizontalHeaderItem(1)
        item.setText(_translate("MainWindowSusi", "Peat Type"))
        ...
        item.setText(_translate("MainWindowSusi", "Density"))
        self.groupBoxApriori.setTitle(_translate("MainWindowSusi", "Figures"))
        self.pushButtonWeather.setText(_translate("MainWindowSusi", "Plot Weather Data"))
        self.pushButtonMotti.setText(_translate("MainWindowSusi", "Plot Forest"))
        item = self.tableWidgetScenario.horizontalHeaderItem(0)
        item.setText(_translate("MainWindowSusi", "Scenario"))
        item = self.tableWidgetScenario.horizontalHeaderItem(1)
        item.setText(_translate("MainWindowSusi", "Ditch Depth [cm]"))
        ...
        item.setText(_translate("MainWindowSusi", "Groundwater, summer [m]"))
        item = self.tableWidgetResults.verticalHeaderItem(1)
        item.setText(_translate("MainWindowSusi", "Groundwater: change [m]"))
        item = self.tableWidgetResults.verticalHeaderItem(2)
        item.setText(_translate("MainWindowSusi", "Volume, start [m3 ha-1]"))
        item = self.tableWidgetResults.verticalHeaderItem(3)
        item.setText(_translate("MainWindowSusi", "Volume, end [m3 ha-1]"))
        item = self.tableWidgetResults.verticalHeaderItem(4)
        item.setText(_translate("MainWindowSusi", "Yield [m3 ha-1]"))
        item = self.tableWidgetResults.verticalHeaderItem(5)
        item.setText(_translate("MainWindowSusi", "Yield, change [m3 ha-1]"))
        item = self.tableWidgetResults.verticalHeaderItem(6)
        item.setText(_translate("MainWindowSusi", "Growth [m3 ha-1 a-1]"))
        item = self.tableWidgetResults.verticalHeaderItem(7)
        item.setText(_translate("MainWindowSusi", "Growth, change [m3 ha-1 a-1]"))
        item = self.tableWidgetResults.verticalHeaderItem(8)
        item.setText(_translate("MainWindowSusi", "Logs, end [m3 ha-1]"))
        item = self.tableWidgetResults.verticalHeaderItem(9)
        item.setText(_translate("MainWindowSusi", "Logs: change [m3 ha-1]"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindowSusi", "Results"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindowSusi", "Team"))
        self.groupBoxSimulation.setTitle(_translate("MainWindowSusi", "Simulation"))
        self.label_start.setText(_translate("MainWindowSusi", "Start Year"))
        self.label_end_year.setText(_translate("MainWindowSusi", "End Year"))
        self.groupBoxSite.setTitle(_translate("MainWindowSusi", "Forest and Site"))
        self.label_stand_age.setText(_translate("MainWindowSusi", "Age, years"))
        self.lineEditAge.setText(_translate("MainWindowSusi", "40"))
        self.labelStripWidth.setText(_translate("MainWindowSusi", "Strip Width, m"))
        self.lineEditStripWidth.setText(_translate("MainWindowSusi", "40"))
        self.labelSitePara.setText(_translate("MainWindowSusi", "Site Type"))
        self.comboBoxSitePara.setItemText(0, _translate("MainWindowSusi", "Herb-rich peatland forest, Sphagnum peat"))
        self.comboBoxSitePara.setItemText(1, _translate("MainWindowSusi", "Herb-rich peatland forest, other peat"))
        self.comboBoxSitePara.setItemText(2, _translate("MainWindowSusi", "Myrtillus peatland forest, Sphagnum peat"))
        self.comboBoxSitePara.setItemText(3, _translate("MainWindowSusi", "Myrtillus peatland forest, other peat"))
        self.comboBoxSitePara.setItemText(4, _translate("MainWindowSusi", "Vaccinium peatland forest, Sphagnum peat"))
        self.comboBoxSitePara.setItemText(5, _translate("MainWindowSusi", "Vaccinium peatland forest, other peat"))
        self.comboBoxSitePara.setItemText(6, _translate("MainWindowSusi", "Dwarf-shrub peatland forest, Sphagnum peat"))
        self.comboBoxSitePara.setItemText(7, _translate("MainWindowSusi", "Dwarf-shrub peatland forest, other peat"))
        self.lineEditLogPrice.setText(_translate("MainWindowSusi", "57.9"))
        self.label_2.setText(_translate("MainWindowSusi", "Log price € m-3"))
        self.label_3.setText(_translate("MainWindowSusi", "Pulpwood price € m-3"))
        self.lineEditPulpPrice.setText(_translate("MainWindowSusi", "20.1"))
        self.label_4.setText(_translate("MainWindowSusi", "Drainage cost € ha-1"))
        self.lineEditDitchCost.setText(_translate("MainWindowSusi", "200.0"))
        self.groupBoxRun.setTitle(_translate("MainWindowSusi", "Calculate"))
        self.pushButtonRunSusi.setText(_translate("MainWindowSusi", "Calculate"))
        self.groupBoxFiles.setTitle(_translate("MainWindowSusi", "Files"))
        self.pushButtonHaeParametriTiedosto.setText(_translate("MainWindowSusi", "Motti file"))
        self.pushButtonGetWeatherFile.setText(_translate("MainWindowSusi", "Weather Data"))
        self.pushButtonGeWorkFolder.setText(_translate("MainWindowSusi", "Output File"))
    ...
    def get_ini_para(self, folderName=None, hdomSim=None, volSim=None, scen = None,
        ...
        spara ={ 
            ...
            'Herb-rich peatland forest, Sphagnum peat':{
            'species': 'Pine', 'sfc':2, 'sfc_specification': 2, 'hdom':hdomSim, 'vol':volSim, 'age':ageSim, 'smc': 'Peatland',
            ...
            'ditch depth': ddwest,  # For compatibility with susi_io.py
            ...
            'ditch depth 20y': ddwest,  # For compatibility with susi_io.py
            ...
            'depoN': 4.0, 'depoP':0.1, 'depoK':1.0,  # Adding deposition parameters
            'fertilization': {
                'application year': 9999,  # Set to a high number to effectively disable fertilization
                'N': {'eff': 0.7, 'dose': 0.0, 'decay_k': 0.1},
                'P': {'eff': 0.7, 'dose': 0.0, 'decay_k': 0.1},
                'K': {'eff': 0.7, 'dose': 0.0, 'decay_k': 0.1}
            }
             },  

            'Herb-rich peatland forest, other peat':{
            'species': 'Pine', 'sfc':2, 'sfc_specification': 2, 'hdom':hdomSim, 'vol':volSim, 'age':ageSim, 'smc': 'Peatland',
            'nLyrs':30, 'dzLyr': 0.05, 'L': sarkaSim, 'n':n, 
            'ditch depth west': ddwest,   #nLyrs kerrosten lkm, dzLyr kerroksen paksuus m, saran levys m, n laskentasolmulen lukumäärä, ditch depth pjan syvyys simuloinnin alussa m  
            'ditch depth east': ddeast,
            ...
            'Myrtillus peatland forest, Sphagnum peat':{
            'species': 'Pine', 'sfc':3, 'sfc_specification': 2, 'hdom':hdomSim, 'vol':volSim, 'age':ageSim, 'smc': 'Peatland',
            'nLyrs':30, 'dzLyr': 0.05, 'L': sarkaSim, 'n':n, 
            'ditch depth west': ddwest,   #nLyrs kerrosten lkm, dzLyr kerroksen paksuus m, saran levys m, n laskentasolmulen lukumäärä, ditch depth pjan syvyys simuloinnin alussa m  
            'ditch depth east': ddeast,
            'ditch depth': ddwest,  # For compatibility with susi_io.py
            ...
            'Myrtillus peatland forest, other peat':{
            'species': 'Pine', 'sfc':3, 'sfc_specification': 2, 'hdom':hdomSim, 'vol':volSim, 'age':ageSim, 'smc': 'Peatland',
            'nLyrs':30, 'dzLyr': 0.05, 'L': sarkaSim, 'n':n, 
            'ditch depth west': ddwest,   #nLyrs kerrosten lkm, dzLyr kerroksen paksuus m, saran levys m, n laskentasolmulen lukumäärä, ditch depth pjan syvyys simuloinnin alussa m  
            'ditch depth east': ddeast,
            ...
            'Vaccinium peatland forest, Sphagnum peat':{
            'species': 'Pine', 'sfc':4, 'sfc_specification': 1, 'hdom':hdomSim, 'vol':volSim, 'age':ageSim, 'smc': 'Peatland',
            'nLyrs':30, 'dzLyr': 0.05, 'L': sarkaSim, 'n':n, 
            'ditch depth west': ddwest,   #nLyrs kerrosten lkm, dzLyr kerroksen paksuus m, saran levys m, n laskentasolmulen lukumäärä, ditch depth pjan syvyys simuloinnin alussa m  
            'ditch depth east': ddeast,
            'ditch depth': ddwest,  # For compatibility with susi_io.py
            ...
            'Vaccinium peatland forest, other peat':{
            'species': 'Pine', 'sfc':4, 'sfc_specification': 1, 'hdom':hdomSim, 'vol':volSim, 'age':ageSim, 'smc': 'Peatland',
            'nLyrs':30, 'dzLyr': 0.05, 'L': sarkaSim, 'n':n, 
            'ditch depth west': ddwest,   #nLyrs kerrosten lkm, dzLyr kerroksen paksuus m, saran levys m, n laskentasolmulen lukumäärä, ditch depth pjan syvyys simuloinnin alussa m  
            'ditch depth east': ddeast,
            ...
            'Dwarf-shrub peatland forest, Sphagnum peat':{
            'species': 'Pine', 'sfc':5, 'sfc_specification': 1, 'hdom':hdomSim, 'vol':volSim, 'age':ageSim, 'smc': 'Peatland',
            'nLyrs':30, 'dzLyr': 0.05, 'L': sarkaSim, 'n':n, 
            'ditch depth west': ddwest,   #nLyrs kerrosten lkm, dzLyr kerroksen paksuus m, saran levys m, n laskentasolmulen lukumäärä, ditch depth pjan syvyys simuloinnin alussa m  
            'ditch depth east': ddeast,
            'ditch depth': ddwest,  # For compatibility with susi_io.py
            ...
            'Dwarf-shrub peatland forest, other peat':{
            'species': 'Pine', 'sfc':5, 'sfc_specification': 1, 'hdom':hdomSim, 'vol':volSim, 'age':ageSim, 'smc': 'Peatland',
            'nLyrs':30, 'dzLyr': 0.05, 'L': sarkaSim, 'n':n, 
            'ditch depth west': ddwest,   #nLyrs kerrosten lkm, dzLyr kerroksen paksuus m, saran levys m, n laskentasolmulen lukumäärä, ditch depth pjan syvyys simuloinnin alussa m  
            'ditch depth east': ddeast,
